...
namespace MicroAssistant.DataAccess
{
    public class ContractInfoAccessor
    {
        ...
        private ContractInfoAccessor()
        {
            ...
            cmdInsertContractInfo = new MySqlCommand("INSERT INTO contract_info(chance_id,contract_no,c_name,customer_name,start_time,end_time,owner_id,contract_time,amount,howtopay,ent_id) values (@ChanceId,@ContractNo,@CName,@CustomerName,@StartTime,@EndTime,@OwnerId,@ContractTime,@Amount,@Howtopay,@EntId)");

            cmdInsertContractInfo.Parameters.Add("@ChanceId", MySqlDbType.Int32);
            ...
            cmdUpdateContractInfo = new MySqlCommand(" update contract_info set chance_id = @ChanceId, contract_no = @ContractNo,c_name = @CName,customer_name = @CustomerName,start_time = @StartTime,end_time = @EndTime,owner_id = @OwnerId,contract_time = @ContractTime,amount = @Amount,howtopay = @Howtopay,ent_id = @EntId where contract_info_id = @ContractInfoId");
            ...
            cmdUpdateContractInfo.Parameters.Add("@ChanceId", MySqlDbType.Int32);
            ...
            cmdLoadAllContractInfo = new MySqlCommand(" select chance_id,contract_info_id,contract_no,c_name,customer_name,start_time,end_time,owner_id,contract_time,amount,howtopay,ent_id from contract_info");

            #endregion

            #region cmdGetContractInfo

            cmdGetContractInfo = new MySqlCommand(" select chance_id, contract_info_id,contract_no,c_name,customer_name,start_time,end_time,owner_id,contract_time,amount,howtopay,ent_id from contract_info where contract_no = @ContractNo");
